...
/**
 * <p>Simple configuration object reader/write with lookup capabilities.</p>
 *
 * <p>ApplicationConfig reads a config file and stores the key,value
 ...
 * never write it back again.</p>
 *
 * <p>The file is located using the <em>user.home</em> system property,
 ...
 * application is running for the first time.</p>
 *
 * <p>The configuration file is called [appname][extension]. If it is
 ...
 * applets may save their configuration as described above.</p>
 */
public class ApplicationConfig {
    ...
    /**
     * <p>Put a key=value pair in the current section. If there is no
    ...
    /**
     * <p>Put a key=value pair in the requested section.
    ...
    protected void readConfig()
        ...
        // read
        hasBeenRead = true;
        if (fileAccess && configFile.exists()) {
            readConfig(new LineNumberReader(new FileReader(configFile)));
            dirty = false;
        } else {
