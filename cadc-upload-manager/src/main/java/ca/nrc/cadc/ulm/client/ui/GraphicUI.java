 ...
 * to the rules of conduct in Swing:</p>
 *
 * <p>1. Swing Components must be created in the EDT (Event Dispatch Thread)
 * 2. Swing Components must be accessed in the EDT, unless calling methods
 * documented as "thread safe".</p>
 *
 * <p>Even if a Component is documented as thread-safe, it is not necessarily to
 * be trusted as such.</p>
 *
 * @author jenkinsd
 */
